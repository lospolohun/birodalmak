...
export const ovatos = motor({
  ...
  terv: [
    ...
    ['vam', (s) => (vamKell(s) ? 1 : 0)],
    ['seprupark', (s, f) => (f > 60 ? 1 : 0)],
    ['hoforras', (s) => (s.dimenzioNyitva('parazsmely') ? 1 : 0)],
    ['jegkamra', (s) => (s.dimenzioNyitva('fagyperem') ? 1 : 0)],
    ['konyvesbolt', (s, f) => (f > 80 ? 1 : 0)],
    ['orvos', 1],
    ['vip', 1],
  ],
